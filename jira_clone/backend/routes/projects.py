...
from controllers.project_controller import create_project, get_projects, get_dashboard_stats, update_project, delete_project, transfer_admin, get_project_progress
...
projects_bp.route('/projects/<int:project_id>/transfer-admin', methods=['POST'])(transfer_admin)
