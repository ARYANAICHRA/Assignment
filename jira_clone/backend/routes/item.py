...
# Subtask endpoints
@item_bp.route('/items/<int:item_id>/subtasks', methods=['GET'])
def get_subtasks_route(item_id):
    return get_subtasks(item_id)

@item_bp.route('/items/<int:item_id>/subtasks', methods=['POST'])
...
@item_bp.route('/items/<int:item_id>/activity', methods=['GET'])
